...
app.post("/create-subscription", async (req, res) => {
  ...
  const customerId = "cus_QAGiTddy1SJiKJ";
  ...
  try {
    const subscription = await stripe.subscriptions.create({
      ...
      // default_incompleteの指定を推奨
      // https://docs.stripe.com/billing/subscriptions/overview#subscription-payment-behavior
